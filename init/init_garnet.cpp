...
void vendor_load_properties() {
    ...
    if (region == "IN") {
        ...
        if (sku == "garnet") {
            brand = "Redmi";
            description = "garnet_in-user 14 UKQ1.231003.002 V816.0.13.0.UNRINXM release-keys";
            fingerprint = "Redmi/garnet_in/garnet:14/UKQ1.231003.002/V816.0.13.0.UNRINXM/release-keys";
            marketname = "Redmi Note 13 Pro 5G";
            model = "2312DRA50I";
        } else {
            brand = "POCO";
            description = "garnetp_in-user 14 UKQ1.231003.002 V816.0.13.0.UNRINXM release-keys";
            fingerprint = "POCO/garnetp_in/garnet:14/UKQ1.231003.002/V816.0.13.0.UNRINXM/release-keys";
